...
namespace james1985\webman\validate;

use Closure;
use think\facade\Db;
use Webman\File;
use james1985\webman\validate\exception\ValidateException;
use james1985\webman\validate\helper\Str;
use james1985\webman\validate\ValidateRule;
...
class Validate
{
    ...
    protected function checkMime(File $file, $mime): bool
    {
        ...
        $getMime = finfo_file($finfo, $this->getPathname());
